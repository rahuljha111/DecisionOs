...
async def get_google_calendar_events(
    ...
    # Use utcnow() to match the 'Z' suffix used in Google Calendar API calls
    # This prevents timezone misalignment (e.g. searching 5 hours into the future)
    now = datetime.utcnow()
    
    # Ensure hours is a positive integer
    search_hours = max(1, int(hours))
